      ...
      children: [
        ...
        Text("Buat Akun Baru",
            ...
            .shimmer(
                delay: 300.ms,
                duration: 1600.ms,
                color: controller.primaryColor.withOpacity(0.4)),
        ...
        Obx(() => AnimatedSwitcher(
              ...
              child: Text(
                controller.headerTexts.isNotEmpty
                    ? controller.headerTexts[controller.currentTextIndex.value]
                    : "Gabung dan mulai perjalananmu!",
  ...
  Widget _buildRegisterForm(BuildContext context) {
    ...
    return Animate(
      effects: [
        ...
        SlideEffect(begin: const Offset(0, 0.08), curve: Curves.easeOut)
      ],
      child: Container(
