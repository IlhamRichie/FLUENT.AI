...
class ProgresView extends GetView<ProgresController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        // Obx utama untuk menangani state loading
        ...
        return CustomScrollView(
          ...
          slivers: [
            SliverToBoxAdapter(
                child: _buildTimeframeSelector(theme, primaryColor)),
          ...
          child: Column(
            children: [
              _customSegmentedButton(
                  ...
                  controller.changeTimeframe,
                  primaryColor),
              const SizedBox(height: 12),
              _customSegmentedButton(
                  controller.chartDataOptions,
                  controller.selectedChartData,
                  controller.changeChartData,
                  primaryColor),
            ],
          ),
        ),
  ...
  Widget _customSegmentedButton(RxList<String> options, RxString selectedOption,
      Function(String) onSelectionChanged, Color primaryColor) {
    return SizedBox(
      height: 40,
            ...
            return Obx(() => ChoiceChip(
                  ...
                  labelStyle: TextStyle(
                    color: selectedOption.value == option
                        ? primaryColor
                        : Colors.grey[700],
                    fontWeight: selectedOption.value == option
                        ? FontWeight.bold
                        : FontWeight.normal,
                    fontSize: 13,
                  ),
                        ...
                        SplineSeries<Map<String, dynamic>, String>(
                          ...
                          dataLabelSettings: DataLabelSettings(
                            ...
                            margin: const EdgeInsets.all(
                                5), // Mengganti 'padding' dengan 'margin'
                          ),
  ...
  Widget _buildSkillMetricsGrid(ThemeData theme) {
    return Obx(() {
      if (controller.skillMetrics.isEmpty)
          ...
          delegate: SliverChildBuilderDelegate(
            (context, index) {
              ...
              return _buildSkillMetricCard(
                  title: entry.key, value: entry.value, theme: theme);
            },
  ...
  Widget _buildImprovementAreasList(ThemeData theme) {
    return Obx(() {
      if (controller.improvementAreas.isEmpty)
        return const SliverToBoxAdapter(child: SizedBox.shrink());
      return SliverList(
        delegate: SliverChildBuilderDelegate(
          (context, index) {
        ...
        child: Column(
          ...
          children: [
            ...
            Text(area['description'],
                style: TextStyle(
                    color: Colors.grey[600], height: 1.4, fontSize: 13.5)),
            const SizedBox(height: 12),
            if (area['progress'] != null) ...[
              ClipRRect(
                borderRadius: BorderRadius.circular(5),
                child: LinearProgressIndicator(
                  value: (area['progress'] is int
                      ? area['progress'].toDouble()
                      : area['progress']),
    ...
    return Obx(() {
      ...
      return SliverPadding(
        ...
        sliver: SliverGrid(
          ...
          delegate: SliverChildBuilderDelegate(
            (context, index) =>
                _buildBadgeCard(controller.badges[index], theme),
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: isUnlocked
                      ? Border.all(
                          color: badgeColor.withOpacity(0.3), width: 1.5)
                      : null,
                ),
              ...
              Text(
                ...
                style: TextStyle(
                    ...
                    color: isUnlocked ? badgeColor : Colors.grey[600],
                    fontWeight:
                        isUnlocked ? FontWeight.w500 : FontWeight.normal),
              ),
            ],
          ),
        ),
