...
class LoginView extends GetView<LoginController> {
          ...
          children: [
            Hero(
              ...
              child: Image.asset("assets/images/logo FLUENT.png", height: 90)
                  ...
                  .scaleXY(
                      end: 1.1, duration: 1200.ms, curve: Curves.easeInOutSine)
                  .then(delay: 0.ms)
                  .tint(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
            ...
            colors: [
              ...
              controller.primaryColor.withOpacity(0.08)
            ],
            stops: const [
              0.0,
              0.7,
      ...
      children: [
        ...
        Text("FLUENT",
            ...
            .shimmer(
                delay: 400.ms,
                duration: 1800.ms,
                color: controller.primaryColor.withOpacity(0.5),
                angle: 45),
        const SizedBox(height: 20),
        Obx(() => AnimatedSwitcher(
              ...
              child: Text(
                controller.footerTexts.isNotEmpty
  ...
  Widget _buildLoginForm(BuildContext context) {
    return Animate(
      effects: [
        ...
        SlideEffect(begin: const Offset(0, 0.1), curve: Curves.easeOut)
      ],
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Obx(() => _buildTextFormField(
                  textCtrl:
                      controller.passwordController, // Menggunakan 'textCtrl'
                  hintText: "••••••••",
            ...
            Obx(() => SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      .scaleXY(
                          end: controller.isLoading.value ? 0.98 : 1.0,
                          duration: 100.ms)
                      .shake(
  ...
  Widget _buildTextFormField({
    required TextEditingController
        textCtrl, // Nama parameter sudah benar di definisi
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(14),
              borderSide: BorderSide(color: loginCtrl.primaryColor, width: 2)),
