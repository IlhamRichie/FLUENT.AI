  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(LucideIcons.arrowLeftCircle,
          ...
          child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                ].animate(interval: 60.ms).fadeIn(duration: 350.ms).moveY(
                    begin: 25,
                    end: 0,
                    duration: 300.ms,
    ...
    return Container(
      ...
      child: Column(
        children: [
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: Padding(
                ...
                child: Icon(LucideIcons.mail,
                    color: controller.primaryColor.withOpacity(0.7), size: 20),
              ),
              ...
              focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12),
                  borderSide:
                      BorderSide(color: controller.primaryColor, width: 1.8)),
              ...
              focusedErrorBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12),
                  borderSide:
                      BorderSide(color: Colors.red.shade600, width: 1.8)),
              errorStyle:
                ...
                child: ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    disabledBackgroundColor:
                        controller.primaryColor.withOpacity(0.7),
                    elevation: 3,
                    ...
                    .scaleXY(
                        end: controller.isLoading.value ? 0.95 : 1.02,
                        duration: 150.ms,
                        curve: Curves.easeOut)
                    .then(delay: 0.ms)
                    .scaleXY(
                        end: 1 / (controller.isLoading.value ? 0.95 : 1.02),
                        duration: 150.ms,
                        curve: Curves.easeIn),
              )),
          ...
          TextButton.icon(
            icon:
                Icon(LucideIcons.arrowLeft, size: 18, color: Colors.grey[600]),
            label: Text("Kembali ke Halaman Login",
                style: TextStyle(
                    ...
                    fontWeight: FontWeight.w500)),
            onPressed:
                controller.isLoading.value ? null : controller.backToLogin,
        ...
        children: [
          Icon(LucideIcons.mailCheck, size: 64, color: Colors.green.shade600)
              ...
              .shake(
                  hz: 2,
                  duration: 300.ms,
                  offset: const Offset(3, 0)), // Menggunakan offset
          ...
          Obx(() => Text(
                ...
                textAlign: TextAlign.center,
                style: TextStyle(
                    color: Colors.grey[700], fontSize: 14.5, height: 1.5),
              )),
          const SizedBox(height: 28),
          SizedBox(
            width: double.infinity,
